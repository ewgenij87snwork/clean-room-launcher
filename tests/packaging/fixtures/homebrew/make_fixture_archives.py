...
def make(output: Path, version: str) -> str:
    root = f"clean-room-launcher-v{version}-aarch64-apple-darwin"; binary = f"#!/bin/sh\nprintf 'fixture {version}\\n'\n".encode()
    files = {"LICENSE": b"fixture license\n", "NOTICE": b"fixture notice\n", "VERSION": f"version={version}\nsource_commit={'1' * 40}\ntarget=aarch64-apple-darwin\nevidence_class=lifecycle-fixture\nqualification=NOT_QUALIFIED\n".encode(), "bin/clroom": binary, "share/doc/clean-room-launcher/CHANGELOG.md": b"fixture changelog\n"}
