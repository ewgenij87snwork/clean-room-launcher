...
fn real_mode_prepares_only_a_disposable_local_git_source_and_real_current_evidence() {
    ...
    assert!(refused_json.contains("\"failure_class\":\"INSTALL_REFUSED\"") && refused_json.contains("\"diagnostic\":\"install_tap_allowlist_refused\"") && refused_json.contains("\"cleanup_complete\":true"), "{}", refused_json);
}
