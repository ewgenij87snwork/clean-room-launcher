...
while IFS= read -r file; do
  relative=${file#"$root"/}
  case "$relative" in
    AGENTS.md|README.md|Cargo.toml|Cargo.lock|rust-toolchain.toml|LICENSE|SECURITY.md|GOVERNANCE.md|CHANGELOG.md|deny.toml|install.sh|.gitignore|.github/CODEOWNERS|.github/FUNDING.yml|.github/dependabot.yml|.github/workflows/ci.yml|.github/workflows/release.yml|.github/workflows/release-candidate.yml|.github/workflows/indexnow.yml|.github/workflows/scorecard.yml|schemas/canonical-json-profile.md) ;;
    src/*|docs/*|packaging/*|qualification/*|schemas/contracts/*|schemas/release/*|fixtures/contracts/*|fixtures/core/*|fixtures/catalog/*|fixtures/cli.rs|fixtures/cli/*|fixtures/adapters/*|adapters/declarations/*|tests/contracts/*|tests/core/*|tests/catalog/*|tests/cli.rs|tests/cli/*|tests/fixtures/*|tests/public_identity.rs|tests/release_system.rs|tests/adapters.rs|tests/adapters/*|tests/packaging/*|tests/release/*|controls/*|scripts/check-public-boundary.sh|scripts/check-control-coverage.rb|scripts/indexnow_changed_urls.py|scripts/probe/*|scripts/release/*|scripts/release-build/*|reports/contracts/*|reports/release/*|site/*) ;;
