...
while IFS= read -r file; do
  ...
  case "$relative" in
    ...
    src/*|schemas/contracts/*|fixtures/contracts/*|fixtures/core/*|adapters/declarations/*|tests/contracts/*|tests/core/*|tests/fixtures/*|controls/*|scripts/check-public-boundary.sh|scripts/check-control-coverage.rb|scripts/probe/*|scripts/gates/p02/*|reports/contracts/*|reports/gates/p02/*|reports/gates/p03/*) ;;
