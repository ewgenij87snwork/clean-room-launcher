...
git -C "$scratch/repository" commit -q --allow-empty -m 'fixture: descendant after task 4 receipt'

actual=$("$scratch/repository/scripts/gates/p06/successors/zero-auth-preauthenticated-native-session-v1/test-task-4-receipt.sh" 2>&1)
