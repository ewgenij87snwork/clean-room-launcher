...
jq -e '
  ...
  .provider_birth_boundary == {
    ...
    public_probe_treeish:"HEAD_COMMITTED_IMPLEMENTATION_TREE",
    public_probe_path:"scripts/probe/provider-capabilities.sh",
    public_probe_mode:"100755",
    public_probe_object_type:"blob",
    public_probe_blob_oid:"e3089827b02914093474b72607d7b6a41547316a",
    public_probe_content_sha256:"bfa281f230109be7927e82e3e263beb7f890e87a1d15e9c1adbdf5e98f7f536b",
    public_probe_purpose:"Observe provider capabilities only after opaque preauthenticated-session availability is established.",
    public_probe_scope:"V0_1_PUBLIC_PROBE_EXECUTABLE",
    tracked_public_probe_descendant_count:1,
    unexpected_public_probe_descendant:"REFUSED",
    public_probe_tuple_mismatch:"REFUSED",
    generic_shell_analysis_claimed:false,
    cli_entrypoint_count:2,
    rust_provider_birth_count:1,
    future_unguarded_rust_route_allowed:false
  } and
  .owner_ssot == {
    worklog_prefix:{
