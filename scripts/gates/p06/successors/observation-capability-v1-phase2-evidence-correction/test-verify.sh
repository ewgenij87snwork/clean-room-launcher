...
Task 3 replacement receipt is sealed on the 373c909 lineage and the successor sole gate returned P06_PHASE2_EVIDENCE_CORRECTION_PASS.
...
<p>Текущий этап P06: 53% — 7/13; qualified tuples 0/1; NOT_QUALIFIED; STOPPED_AT_T8</p>
<p>Phase 2 terminal review: REV BLOCKER</p>
...
if run_selected task_3_ssot; then
  prepare_task_3_ssot_fixture
  if ! run_task_3_ssot_semantics >/dev/null 2>&1; then
